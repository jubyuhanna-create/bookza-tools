...
function renderBestPick() {
  ...
  const best = state.topHeroes[0];
  const alts = state.topHeroes.slice(1);
  dom.results.innerHTML = `
    <div class="result-grid">
      <article class="best-card highlight oq-pick-card ${state.selectedPerkHero === best.hero.name ? 'perk-selected' : ''}" data-hero="${best.hero.name}">
